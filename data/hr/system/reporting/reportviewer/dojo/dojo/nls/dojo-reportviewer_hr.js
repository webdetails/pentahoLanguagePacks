...
dojo.provide("dojo.cldr.nls.gregorian.hr");
dojo.cldr.nls.gregorian.hr = {
...
dojo.provide("dijit.form.nls.validate.hr");
dijit.form.nls.validate.hr = {
...
dojo.provide("dojo.cldr.nls.number.hr");
dojo.cldr.nls.number.hr = {
    "group": ",",
    "percentSign": "%",
    "exponential": "E",
    "percentFormat": "#,##0%",
