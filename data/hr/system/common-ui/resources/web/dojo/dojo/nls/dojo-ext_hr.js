dojo.provide("dojo.nls.dojo-ext_hr");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.hr");
dojo.nls.colors.hr = {
...
dojo.provide("dijit._editor.nls.commands.hr");
dijit._editor.nls.commands.hr = {
...
dojo.provide("dijit.form.nls.ComboBox.hr");
dijit.form.nls.ComboBox.hr = {
...
dojo.provide("dijit._editor.nls.FontChoice.hr");
dijit._editor.nls.FontChoice.hr = {
    "noFormat": "None",
    "1": "xx-small",
    "2": "x-small",
    "formatBlock": "Format",
...
dojo.provide("dijit._editor.nls.LinkDialog.hr");
dijit._editor.nls.LinkDialog.hr = {
    "text": "Description:",
...
dojo.provide("dojo.cldr.nls.currency.hr");
dojo.cldr.nls.currency.hr = {
...
dojo.provide("dojox.widget.nls.ColorPicker.hr");
dojox.widget.nls.ColorPicker.hr = {
